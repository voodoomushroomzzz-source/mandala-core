...
Контекст, философия и структура системы — в boot.json и core_map (инжектируются в диалог).
Инструкции по патчам — в honeycombs/instructions/.
...
— Перед любым изменением — read_file актуальной версии файла
